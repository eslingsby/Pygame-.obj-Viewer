...
face = object_class("objects/face.obj", pos = [0, 0, 5], pan = [0, 0, 0])

main_scene.addChild(face)
...
while 1:
	...
	face.set_pan([change_range(0, screen_size[1], -100, 100, mouse_y), change_range(0, screen_size[0], -100, 100, mouse_x), 0])
	#////////[  Update End  ]////////#
